  ...
  return (
    <div className="min-h-screen bg-yellow-400 py-12">
      <div className="container mx-auto max-w-5xl px-4">
        <div className="mb-8 flex items-center justify-between rounded-xl bg-white px-6 py-4 shadow">
          <h1 className="text-2xl text-black">My Parcels</h1>
          ...
          <div className="flex items-center gap-4">
            ...
            <form action={logoutAction}>
              <button
                type="submit"
                className="rounded-lg bg-black px-4 py-2 text-sm font-medium text-white hover:bg-red-600 transition"
              >
                Logout
              </button>
            </form>
